...
require_once(PEAR_DIR.'HTTP.php');
require_once(PEAR_DIR.'HTTP/Header.php');
...
class download
{
	...
	/**
     * Can Thread/Resume Downloads?
     *
     * @see     HTTP_Download::setResume()
     * @access  protected
     * @var     string
     */
	var $resume = false;
     ...
     * Set Resume
     * 
     * Allow file download resume or not, it is set here.
     * 
     * @access  public
     * @return  void
     * @param   string  $etag Entity tag used for strong cache validation.
     */
    function setResume($resume = null)
    {
        $this->resume = (bool) $resume;
    }
    ...
    function send($autoSetContentDisposition = true)
    {
        ...
        if ($autoSetContentDisposition && !isset($this->headers['Content-Disposition'])) 
		{
