...
var niceforms1 = document.getElementsByTagName('input');
var niceformsItems = new Array();
var ste = 0;
for(var i=0; i< niceforms1.length;i++)
{
	if(niceforms1[i].type == 'button') 
	{
		niceformsItems[ste] = niceforms1[i];
		ste++;
	}
}
...
var imagesPath = "images/nicejforms/";
...
function init() 
{
	...
	if(!isMac.test(navigator.vendor)) {
		...
		replaceTextareas();
		buttonHovers();
		buttonHoversStandalone()
	}
}


function buttonHoversStandalone() {
	for (var i = 0; i < niceformsItems.length; i++) {
		niceformsItems[i].className = "buttonSubmit";
		var buttonLeft = document.createElement('img');
		buttonLeft.src = siteUrl + imagesPath + "button_left.gif";
		buttonLeft.className = "buttonImg";
		niceformsItems[i].parentNode.insertBefore(buttonLeft, niceformsItems[i]);
		var buttonRight = document.createElement('img');
		buttonRight.src = siteUrl + imagesPath + "button_right.gif";
		buttonRight.className = "buttonImg";
		if(niceformsItems[i].nextSibling) {niceformsItems[i].parentNode.insertBefore(buttonRight, niceformsItems[i].nextSibling);}
		else {niceformsItems[i].parentNode.appendChild(buttonRight);}
		niceformsItems[i].onmouseover = function() {
			this.className += "Hovered";
			this.previousSibling.src = siteUrl + imagesPath + "button_left_xon.gif";
			this.nextSibling.src = siteUrl + imagesPath + "button_right_xon.gif";
		}
		niceformsItems[i].onmouseout = function() {
			this.className = this.className.replace(/Hovered/g, "");
			this.previousSibling.src = siteUrl + imagesPath + "button_left.gif";
			this.nextSibling.src = siteUrl + imagesPath + "button_right.gif";
		}
	}
}
...
function preloadImages() {
	preloads = new Object();
	preloads[0] = new Image(); preloads[0].src = siteUrl + imagesPath + "button_left_xon.gif";
	preloads[1] = new Image(); preloads[1].src = siteUrl + imagesPath + "button_right_xon.gif";
	preloads[2] = new Image(); preloads[2].src = siteUrl + imagesPath + "input_left_xon.gif";
	preloads[3] = new Image(); preloads[3].src = siteUrl + imagesPath + "input_right_xon.gif";
	preloads[4] = new Image(); preloads[4].src = siteUrl + imagesPath + "txtarea_bl_xon.gif";
	preloads[5] = new Image(); preloads[5].src = siteUrl + imagesPath + "txtarea_br_xon.gif";
	preloads[6] = new Image(); preloads[6].src = siteUrl + imagesPath + "txtarea_cntr_xon.gif";
	preloads[7] = new Image(); preloads[7].src = siteUrl + imagesPath + "txtarea_l_xon.gif";
	preloads[8] = new Image(); preloads[8].src = siteUrl + imagesPath + "txtarea_tl_xon.gif";
	preloads[9] = new Image(); preloads[9].src = siteUrl + imagesPath + "txtarea_tr_xon.gif";
}
...
{
	for(var who = 0; who < checkboxes.length; who++)
	{
		var tester = false;
		if(checkboxLabels[who].className == "chosen") 
		{
...
function replaceSelects() {
    for(var q = 0; q < selects.length; q++) {
		...
		//button.style.marginLeft = selectLeftSideWidth + 'px';
...
function replaceTexts() 
{
	for(var q = 0; q < texts.length; q++) {
		texts[q].style.width = texts[q].size * 5 + 'px';
		txtLeft = document.createElement('img'); txtLeft.src = siteUrl + imagesPath + "input_left.gif"; txtLeft.className = "inputCorner";
		txtRight = document.createElement('img'); txtRight.src = siteUrl + imagesPath + "input_right.gif"; txtRight.className = "inputCorner";
		...
		if(texts[q].id == 'private_key')
		{
			texts[q].style.textTransform = 'uppercase';
			texts[q].style.fontWeight = 'bold'; 
			texts[q].style.verticalAlign = 'middle';
		}
		...
		texts[q].onfocus = function() 
		{
			...
			this.previousSibling.src = siteUrl + imagesPath + "input_left_xon.gif";
			this.nextSibling.src = siteUrl + imagesPath + "input_right_xon.gif";
		}
		
		texts[q].onblur = function() 
		{
			this.className = "textinput";
			this.previousSibling.src = siteUrl + imagesPath + "input_left.gif";
			this.nextSibling.src = siteUrl + imagesPath + "input_right.gif";
		}
	}
}
...
function replaceTextareas() {
	for(var q = 0; q < textareas.length; q++) {
		...
		topLeft.src = siteUrl + imagesPath + "txtarea_tl.gif";
		topLeft.style.float = "left";
		...
		bottomLeft.src = siteUrl + imagesPath + "txtarea_bl.gif";
		bottomLeft.style.float = "left";
		//assemble divs
		...
		textareas[q].onfocus = function() {
			...
			this.parentNode.previousSibling.getElementsByTagName("img")[0].src = siteUrl + imagesPath + "txtarea_tl_xon.gif";
			this.parentNode.nextSibling.className = "br_xon";
			this.parentNode.nextSibling.getElementsByTagName("img")[0].src = siteUrl + imagesPath + "txtarea_bl_xon.gif";
		}
		textareas[q].onblur = function() {
			...
			this.parentNode.previousSibling.getElementsByTagName("img")[0].src = siteUrl + imagesPath + "txtarea_tl.gif";
			this.parentNode.nextSibling.className = "br";
			this.parentNode.nextSibling.getElementsByTagName("img")[0].src = siteUrl + imagesPath + "txtarea_bl.gif";
		}
	}
}
